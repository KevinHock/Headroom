...
from headroom.checks.rcps.deny_sts_third_party_assumerole import DenyStsThirdPartyAssumeRoleCheck
...
class TestCheckDenyStsThirdPartyAssumeRole:
    ...
    def test_roles_with_third_party_accounts(self) -> None:
        ...
        with (
            ...
            check = DenyStsThirdPartyAssumeRoleCheck(
