...
Blocked accounts are consulted against the whole hierarchy, not only against
accounts that produced results, so an OU is judged by every account it governs.
