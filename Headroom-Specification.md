...
check inventory covered 7 of the 15 registered checks, and the same behavior was
...
| Role chain, sessions, regions, account projections | [`spec/architecture/aws-execution.md`](spec/architecture/aws-execution.md) |
