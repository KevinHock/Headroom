...
class KMSKeyPolicyAnalysis:
    ...
    Attributes:
        ...
        has_non_account_principals: True if the policy grants to a principal
            type carrying no account ID, which no allowlist can preserve - `Principal: "*"`, or an Allow with
...
def analyze_kms_key_policies(
    ...
    Raises:
        ...
        UnknownPrincipalTypeError: If any key policy names a principal key
