...
class DenyECRThirdPartyAccessCheck(BaseCheck[ECRPolicyAnalysis]):
    ...
    - ECR policies granting to a principal type carrying no account ID
    ...
    def analyze(self, session: Session) -> List[ECRPolicyAnalysis]:
        ...
        Filters to policies with third-party access, a wildcard, or a
        principal carrying no account ID. Policies with none of the three
